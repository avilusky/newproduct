...
if (cellId === 1) {
    ...
    let content = `
        <div style="padding: 2rem;">
            <p style="text-align: center; color: #64748b; font-size: 1.1rem; line-height: 1.8; margin-bottom: 2rem;">
                ${cell.details.introduction}
            </p>
        </div>
                ...
                <ul class="feature-list">
                    ...
                    <li>
                        ...
                        <div class="feature-content">
                            ...
                            <span class="feature-value">0.2%</span> בלבד
                        </div>
                    </li>
                    <li>
                        <span class="feature-icon">📈</span>
                        <div class="feature-content">
                            <span class="feature-label">תשואה צפויה:</span>
        ...
        <div class="guarantees-section">
            ...
            <div class="guarantees-grid">
                <div class="guarantee-card">
                    ...
                    <div class="guarantee-title">הבטחת מוות</div>
                ...
                <div class="segment-content">
                    <div class="advantage-cards">
                        ...
                        <div class="advantage-card">
                            ...
                            <div class="advantage-value">4% שנתי</div>
            ...
            <div class="target-segment secondary-segment">
                ...
                <div class="segment-content">
                    <div class="comparison-container">
                        ...
                        <div class="comparison-cards">
                            ...
                            <div class="comparison-card kupot">
                                ...
                                <div class="premium-amount">₪255</div>
                                <div class="premium-label">לחודש</div>
                                <div class="total-payments">
                                    <span class="total-label">סה"כ עד גיל 70:</span>
                                    <span class="total-value">₪45,900</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="barriers-list">
                        ...
                        <div class="barrier-item">
                            <span class="barrier-icon">🏥</span>
                            <span class="barrier-text">חיתום רפואי מחמיר בגילאים מבוגרים</span>
                        </div>
                        <div class="barrier-item">
                            <span class="barrier-icon">💸</span>
        ...
        <div data-content="new" class="tab-content active">
            ...
            <div class="timeline-item completed">
                ...
                <div class="timeline-content">
                    ...
                    <div class="timeline-description">
                        החוזר מוכן ומחכה לפרסום. מגדיר את מבנה המוצר, דרישות ההון, וכללי החיתום.
                    </div>
            ...
            <div class="timeline-item pending">
                ...
                <div class="timeline-content">
                    ...
                    <span class="timeline-status status-pending">בתהליך</span>
                </div>
            </div>
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content">
                    ...
                    <div class="timeline-description">
                        הקמת מנגנון לאישור מהיר של פוליסות חדשות. יעד: 30 ימי עבודה.
                    </div>
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content">
                    ...
                    <div class="timeline-description">
                        פרסום מסמך מדיניות מפורט, פתיחת תקופת הערות של 45 ימים.
                    </div>
                    <span class="timeline-status status-future">Q2 2025</span>
                </div>
            </div>
            
            <h3 class="regulation-title">⚠️ מניעת ניצול - "טוויסטינג"</h3>
            
            <div class="risk-card high">
                <h4 style="color: #dc2626; margin-bottom: 1rem;">🔄 הסיכון המרכזי</h4>
                ...
                <div style="padding: 1rem; background: white; border-radius: 8px;">
                    <strong style="color: #059669;">פתרון רגולטורי:</strong><br>
                    • איסור מוחלט על ביטול פוליסות קיימות<br>
                    • חובת השוואה מפורטת בכתב<br>
                    • תקופת צינון מורחבת של 60 יום<br>
                    • קנסות כבדים על הפרות
                </div>
            </div>
        </div>
...
<div data-content="existing" class="tab-content">
    ...
    <div style="padding: 1.5rem; background: linear-gradient(135deg, #fef2f2 0%, #fee2e2 100%); border-radius: 12px; margin-bottom: 2rem;">
        ...
        <p style="color: #7f1d1d;">
            עזיבה המונית של צעירים תוביל לגירעון של 16 מיליארד ₪.
    ...
    <h3 class="regulation-title">🎮 סימולטור איזון המוצר הקיים</h3>
</div>
        ...
        <div style="display: grid; grid-template-columns: 40% 60%; gap: 2rem;">
            <div>
                ...
                <div class="slider-group">
                    ...
                    <input type="range" class="slider-input fund-slider" min="0" max="8" value="0">
                ...
                <div class="advantages-grid">
                        ...
                        <div class="advantage-content">
                            ...
                            <div class="investment-tracks">
                                ...
                                <div class="track">
                                    ...
                                    <span class="track-return">4-5%</span>
                                </div>
                                <div class="track">
                                    <span class="track-name">סיכון גבוה</span>
                                    <span class="track-return">6-7%</span>
                                </div>
                            </div>
                            <p class="advantage-note">לעומת ריבית חסרת סיכון בלבד במודל הקיים</p>
                        </div>
                    </div>
                    ...
                    <div class="advantage-item">
                        ...
                        <div class="advantage-content">
                            ...
                            <div class="total-savings">חיסכון של 7.8% בעלויות תפעול</div>
                        </div>
                    </div>
                    ...
                    <div class="advantage-item">
                        ...
                        <div class="advantage-content">
                            <ul class="flexibility-list">
                                ...
                                <li>אפשרות משיכה במקרים מוגדרים</li>
                ...
                <div class="market-scenarios">
                    <div class="scenario-card">
                        ...
                        <div class="scenario-content">
                            ...
                            <div class="impact-indicator critical">
                                <span>עלייה צפויה בפרמיות: 30-50%</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="scenario-card">
                        ...
                        <div class="scenario-content">
                            ...
                            <div class="impact-indicator warning">
                                <span>שינוי מבני בשוק הביטוח הסיעודי</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="scenarios-list">
                    ...
                    <div class="scenario-item high-risk">
                        ...
                        <div class="scenario-consequence">
                            <strong>השלכה:</strong> בקרנות הפנסיה נדרש מבטח משנה כאשר מספר המבוטחים נמוך מ-1,500
                        </div>
                    </div>
                    ...
                    <div class="scenario-item high-risk">
                        ...
                        <div class="scenario-consequence">
                            <strong>השלכה:</strong> פגיעה ביציבות האקטוארית של המודל
                        </div>
                    </div>
    ...
    <h3 class="column-title">תרחישי קיצון - המודל הקיים</h3>
                ...
                <div class="scenarios-list">
                    ...
                    <div class="scenario-item high-risk">
                        ...
                        <div class="scenario-consequence">
                            <strong>השלכה:</strong> לחצים מרגולטורים ומקופות החולים
                        </div>
                    </div>
                    ...
                    <div class="scenario-item critical-risk">
                        ...
                        <div class="scenario-consequence">
                            <strong>השלכה:</strong> סכנה ממשית להמשך קיום הביטוח הקיים
                        </div>
                    </div>
                </div>
            </div>
    ...
    let content = `
            ...
            <div class="stakeholder-card health-card">
                <div class="card-header">
                    ...
                    <div class="card-info">
                        ...
                        <div class="card-role">רגולטור הבריאות ומפעילי הביטוח הקיים</div>
                    </div>
                </div>
        ...
        <div class="summary-section">
            ...
            <div class="summary-content">
                ...
                <p style="margin-top: 1.5rem; text-align: center; font-weight: 600;">
                    המפתח להצלחה: תקשורת פרואקטיבית, שקיפות, ופעולה בסמכות עצמאית כשנדרש
                </p>
            </div>
        </div>
    `;
        ...
        <div class="risks-container">
                            ...
                            <div class="risk-header">
                                ...
                                <div class="risk-content">
                                    ...
                                    <div class="action-required">
                                        ...
                                        <div class="action-text">אין סיכון משמעותי - זכותנו לפתוח את שוק הפרט מעוגנת בחוק</div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="legal-summary">
                <div class="summary-title">
                    <span>📊</span>
                    <span>סיכום הערכת סיכונים</span>
                </div>
                <div class="summary-grid">
                    <div class="summary-card">
                        <div class="summary-icon">🟢</div>
                        <div class="summary-label">סיכונים נמוכים</div>
                        <div class="summary-value">1</div>
                        <span class="summary-status status-manageable">בשליטה</span>
                    </div>
                    <div class="summary-card">
                        <div class="summary-icon">🟡</div>
                        <div class="summary-label">סיכונים בינוניים</div>
                        <div class="summary-value">1</div>
                        <span class="summary-status status-attention">דורש טיפול</span>
                    </div>
                    <div class="summary-card">
                        <div class="summary-icon">🔴</div>
                        <div class="summary-label">סיכונים גבוהים</div>
                        <div class="summary-value">3</div>
                        <span class="summary-status status-attention">תלוי משבר</span>
                    </div>
                </div>
            </div>
            ...
            <div class="legal-alert">
                ...
                <div class="alert-content">
                    <div class="alert-title">נקודה קריטית להצלחה</div>
                    <div class="alert-text">
                        רוב הסיכונים המשמעותיים תלויים בהתפתחות משבר בקופות החולים. 
                        הכנה מוקדמת ותוכנית מגירה לתרחישים אלה תאפשר תגובה מהירה ויעילה במידת הצורך.
...
if (cell.details.isAdvantages) {
    ...
    let content = `
        ...
        <div class="advantages-header">
            ...
            <div class="advantages-subtitle">פתרון מקיף ומאוזן לביטוח סיעודי</div>
        </div>
        ...
        <div class="advantages-grid">
            ...
            <div class="advantage-category">
                <div class="category-header">
                    ...
                    <span class="category-title">יתרונות כלכליים</span>
                </div>
                <ul class="advantage-list">
                    ...
                    <li class="advantage-item">
                        <span class="item-icon">✓</span>
                        <span class="item-text">דמי ניהול של 0.2% בלבד לעומת 5-8% במודל הקיים</span>
                    </li>
                    <li class="advantage-item">
                        <span class="item-icon">✓</span>
                        <span class="item-text">תשואות שוק ההון (4% צפוי) על החיסכון</span>
                    </li>
                    <li class="advantage-item">
                        <span class="item-icon">✓</span>
            ...
            <div class="advantage-category">
                <div class="category-header">
                    ...
                    <span class="category-title">יתרונות ביטוחיים</span>
                </div>
                <ul class="advantage-list">
                    <li class="advantage-item">
                        <span class="item-icon">✓</span>
                        <span class="item-text">ביטוח מובטח מגיל 70 ללא חיתום נוסף</span>
                    </li>
                    <li class="advantage-item">
                        <span class="item-icon">✓</span>
                        <span class="item-text">תגמול חודשי של ₪5,000 ל-60 חודשים</span>
                    </li>
                    <li class="advantage-item">
                        <span class="item-icon">✓</span>
                        <span class="item-text">הבטחת מוות: ₪30,000 במקרה פטירה</span>
                    </li>
                    <li class="advantage-item">
                        <span class="item-icon">✓</span>
                        <span class="item-text">תשלום מינימלי מובטח של 12 חודשים</span>
                    </li>
                    <li class="advantage-item">
                        <span class="item-icon">✓</span>
                        <span class="item-text">תקופת המתנה של 60 יום בלבד</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="advantage-category">
                <div class="category-header">
                    <span class="category-icon">🏗️</span>
                    <span class="category-title">יתרונות מבניים</span>
                </div>
                <ul class="advantage-list">
                    <li class="advantage-item">
                        <span class="item-icon">✓</span>
                    ...
                    <li class="advantage-item">
                        <span class="item-icon">✓</span>
                        <span class="item-text">גמישות בבחירת מסלולי השקעה</span>
                    </li>
                    <li class="advantage-item">
                        <span class="item-icon">✓</span>
                        <span class="item-text">שקיפות מלאה - חשבון אישי על שם המבוטח</span>
                    </li>
                    <li class="advantage-item">
                        <span class="item-icon">✓</span>
                        <span class="item-text">ללא סבסוד צולב בין מבוטחים</span>
                    </li>
                    <li class="advantage-item">
                        <span class="item-icon">✓</span>
                        <span class="item-text">אפשרות משיכה במקרים מוגדרים</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="advantage-category">
                <div class="category-header">
                    <span class="category-icon">📈</span>
                    <span class="category-title">יתרונות לשוק</span>
                </div>
                <ul class="advantage-list">
                    <li class="advantage-item">
                        <span class="item-icon">✓</span>
                        <span class="item-text">יצירת תחרות בריאה בענף הסיעוד</span>
                    </li>
                    <li class="advantage-item">
                        <span class="item-icon">✓</span>
                        <span class="item-text">מודל בר-קיימא ללא תלות בסבסוד</span>
                    </li>
                    <li class="advantage-item">
                        <span class="item-icon">✓</span>
                    ...
                    <li class="advantage-item">
                        <span class="item-icon">✓</span>
                        <span class="item-text">פתרון לבעיית הגירעון האקטוארי</span>
                    </li>
                </ul>
            </div>
        </div>
...
if (cell.details.isDisadvantages) {
    ...
    let content = `
        ...
        <div class="disadvantages-header">
            ...
            <div class="disadvantages-subtitle">האתגרים המרכזיים שיש להיערך אליהם</div>
        </div>
        ...
        <div class="disadvantages-grid">
            ...
            <div class="disadvantage-category">
                <div class="category-header">
                    <span class="category-icon">👥</span>
                    <span class="category-title">אתגרים למבוטחים</span>
                </div>
                <ul class="disadvantage-list">
                    <li class="disadvantage-item">
                        <span class="item-icon">✗</span>
                        <span class="item-text">פרמיות גבוהות מאוד למצטרפים מעל גיל 55</span>
                    </li>
                    <li class="disadvantage-item">
                        <span class="item-icon">✗</span>
                        <span class="item-text">חיתום רפואי מלא - סיכון לדחייה</span>
                    </li>
                    <li class="disadvantage-item">
                        <span class="item-icon">✗</span>
                        <span class="item-text">אין אפשרות הצטרפות אחרי גיל 70</span>
                    </li>
                    <li class="disadvantage-item">
                        <span class="item-icon">✗</span>
                        <span class="item-text">סיכון לאירוע מס במעבר בין השלבים</span>
                    </li>
                    <li class="disadvantage-item">
                        <span class="item-icon">✗</span>
            ...
            <div class="disadvantage-category">
                <div class="category-header">
                    <span class="category-icon">🚧</span>
                    <span class="category-title">אתגרי יישום</span>
                </div>
                <ul class="disadvantage-list">
                    <li class="disadvantage-item">
                        <span class="item-icon">✗</span>
                        <span class="item-text">חוסר היענות פוטנציאלי של מבוטחים</span>
                    </li>
                    <li class="disadvantage-item">
                        <span class="item-icon">✗</span>
                        <span class="item-text">חשש מחוסר היענות של מבטחים</span>
                    </li>
                    <li class="disadvantage-item">
                        <span class="item-icon">✗</span>
                    ...
                    <li class="disadvantage-item">
                        <span class="item-icon">✗</span>
                        <span class="item-text">צורך במספר מינימלי של מבוטחים ליציבות</span>
                    </li>
                    <li class="disadvantage-item">
                        <span class="item-icon">✗</span>
                        <span class="item-text">תקופת מעבר ארוכה עד להבשלת המודל</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="disadvantage-category">
                <div class="category-header">
                    <span class="category-icon">💥</span>
                    <span class="category-title">השפעות מערכתיות</span>
                </div>
                <ul class="disadvantage-list">
                    <li class="disadvantage-item">
                        <span class="item-icon">✗</span>
                        <span class="item-text">סכנת קריסה למוצר הקיים בקופות</span>
                    </li>
                    <li class="disadvantage-item">
                        <span class="item-icon">✗</span>
                        <span class="item-text">גירעון של 16 מיליארד ₪ צפוי בקופות</span>
                    </li>
                    <li class="disadvantage-item">
                        <span class="item-icon">✗</span>
                        <span class="item-text">נטישת צעירים תייקר למבוגרים שיישארו</span>
                    </li>
                    <li class="disadvantage-item">
                        <span class="item-icon">✗</span>
                        <span class="item-text">התנגדות צפויה ממשרד הבריאות וקופות</span>
                    </li>
                    <li class="disadvantage-item">
                        <span class="item-icon">✗</span>
                        <span class="item-text">עימות פוטנציאלי עם משרד האוצר</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="disadvantage-category">
                <div class="category-header">
                    <span class="category-icon">⚖️</span>
                    <span class="category-title">סיכונים משפטיים</span>
                </div>
                <ul class="disadvantage-list">
                    <li class="disadvantage-item">
                        <span class="item-icon">✗</span>
                        <span class="item-text">סיכון לתביעות ייצוגיות</span>
                    </li>
                    <li class="disadvantage-item">
                        <span class="item-icon">✗</span>
                        <span class="item-text">אי וודאות לגבי פרה-רולינג מס</span>
                    </li>
                    <li class="disadvantage-item">
                        <span class="item-icon">✗</span>
                        <span class="item-text">מעבר אפשרי לקרן אחת בקופות</span>
                    </li>
                    <li class="disadvantage-item">
                        <span class="item-icon">✗</span>
                        <span class="item-text">סיכון לפירוק הביטוח בקופות</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="mitigation-note">
            <div class="mitigation-title">📌 הערה חשובה</div>
            <div class="mitigation-text">
                למרות האתגרים המשמעותיים, רובם ניתנים לניהול באמצעות תכנון נכון, תקשורת פרואקטיבית והיערכות מתאימה.
                הסיכון המרכזי הוא להמשך הסטטוס קוו שיוביל לקריסת המערכת הקיימת ללא חלופה ראויה.
                הפעלת המודל החדש, גם עם החסרונות שלו, עדיפה על המשך המצב הנוכחי.
            </div>
        </div>
    `;
